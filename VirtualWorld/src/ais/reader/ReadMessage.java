...
public class ReadMessage extends Thread {
	...
	public ArrayList<Integer> getShipMmsi(){	
		ArrayList<Integer> tempShipMmsi = new ArrayList<>();
	...
	private void createShipHashMap(AisMessage aisMessage) {
	    ...
	    if (aisMessage instanceof AisStaticCommon) {
	        ...
	        try {
	        	ship.setShipBow(staticMessage.getDimBow());
	        	ship.setShipPort(staticMessage.getDimPort());
	        	ship.setShipStarboard(staticMessage.getDimStarboard());		// width of the ship
	        	ship.setSHipStern(staticMessage.getDimStern());				// length of the ship
